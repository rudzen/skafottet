...
public class SkafotDream extends DreamService {
    ...
    public void onAttachedToWindow() {
        ...
        setContentView(R.layout.skafottet);

        mDreamTextView = (TextView) findViewById(R.id.dream_text);
        mDreamTextView.setText(getTextFromPreferences());

//        sf = (StarField) findViewById(R.id.sf_dream);

//        sf.init(getWindow().getWindowManager().getDefaultDisplay().getWidth(), getWindow().getWindowManager().getDefaultDisplay().getHeight() , Color.RED);
